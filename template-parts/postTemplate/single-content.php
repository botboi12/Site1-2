<?php if (function_exists('wc_get_product') && (is_cart() || is_shop() || is_product())) { the_content(); } else { ?><?php global $wp_query;
 ?>
<?php $skip_min_height = false; ?><section class="u-align-center u-clearfix u-section-1" id="sec-6abd">
  <div class="u-clearfix u-sheet u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1"><!--post_details--><!--post_details_options_json--><!--{"source":""}--><!--/post_details_options_json--><!--blog_post-->
    <div class="u-container-style u-expanded-width u-post-details u-post-details-1">
      <div class="u-container-layout u-valign-middle u-container-layout-1"><!--blog_post_image-->
        ...
        <div class="u-align-justify u-blog-control u-post-content u-text u-text-2"><?php echo is_singular() || $post->post_type !== 'post' ? theme_get_content() : theme_get_excerpt(); ?></div><!--/blog_post_content-->
      </div>
