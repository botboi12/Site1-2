<?php global $wp_query;
 ?>
<?php $skip_min_height = false; ?><section class="u-clearfix u-section-1" id="sec-9cd8">
...
?>
    ...
    <div class="u-blog u-expanded-width u-repeater u-repeater-1"><?php
                                    $countItems = 3;
      ...
      <?php $postItemInvisible = !has_post_thumbnail() ? true : false; ?><div class="u-blog-post u-container-style u-repeater-item u-white u-repeater-item-1">
        <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1"><!--blog_post_header-->
          ...
          <div class="u-blog-control u-post-content u-text u-text-2"><?php echo is_singular() || $post->post_type !== 'post' ? theme_get_content() : theme_get_excerpt(); ?></div><!--/blog_post_content--><!--blog_post_readmore-->
      ...
      <?php $postItemInvisible = !has_post_thumbnail() ? true : false; ?><div class="u-blog-post u-container-style u-repeater-item u-video-cover u-white">
        <div class="u-container-layout u-similar-container u-valign-top u-container-layout-2"><!--blog_post_header-->
          ...
          <?php
                            ...
                            if ($post_image) echo $post_image; else { echo '<div class="none-post-image" style="display: none;"></div>'; $skip_min_height = true; } ?><!--/blog_post_image--><!--blog_post_content-->
          <div class="u-blog-control u-post-content u-text u-text-4"><?php echo is_singular() || $post->post_type !== 'post' ? theme_get_content() : theme_get_excerpt(); ?></div><!--/blog_post_content--><!--blog_post_readmore-->
          <a href="<?php the_permalink(); ?>" class="u-blog-control u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-none u-btn-2"><?php _e(sprintf(__('Read more', 'site1'))); ?></a><!--/blog_post_readmore-->
        </div>
      ...
      <?php $postItemInvisible = !has_post_thumbnail() ? true : false; ?><div class="u-blog-post u-container-style u-repeater-item u-video-cover u-white">
        <div class="u-container-layout u-similar-container u-valign-top u-container-layout-3"><!--blog_post_header-->
          ...
          <?php
                            ...
                            if ($post_image) echo $post_image; else { echo '<div class="none-post-image" style="display: none;"></div>'; $skip_min_height = true; } ?><!--/blog_post_image--><!--blog_post_content-->
          <div class="u-blog-control u-post-content u-text u-text-6"><?php echo is_singular() || $post->post_type !== 'post' ? theme_get_content() : theme_get_excerpt(); ?></div><!--/blog_post_content--><!--blog_post_readmore-->
          <a href="<?php the_permalink(); ?>" class="u-blog-control u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-none u-btn-3"><?php _e(sprintf(__('Read more', 'site1'))); ?></a><!--/blog_post_readmore-->
        </div>
