...
?>
<?php
$metaGeneratorContent = 'Nicepage 3.21.3, nicepage.com';
$meta_generator = '';
...
<div id="page" class="site">
    ...
    <?php if (!$hideHeader) { ?>
    <header class="u-clearfix u-header u-palette-1-dark-1 u-header" id="sec-6b10">
  <div class="u-clearfix u-sheet u-sheet-1">
    <?php $logo = theme_get_logo(array(
            'default_src' => "/images/logo2.png",
            'default_url' => home_url('/')
        )); ?><a <?php if (is_customize_preview()) echo 'data-default-src="' . esc_url($logo['default_src']) . '" '; ?>href="<?php echo esc_url($logo['url']); ?>" class="u-image u-logo u-image-1 custom-logo-link" data-image-width="140" data-image-height="50">
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'menu' => array(
                    ...
                    'link_class' => 'u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-light-1 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-grey-90 u-text-grey-90 u-text-hover-grey-90',
                    'link_style' => 'padding: 10px 0px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-d519-19',
                ...
                'responsive_menu' => array(
                    ...
                    'link_style' => 'padding: 10px 0px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-d519-20',
                    'submenu_item_class' => 'u-nav-item',
